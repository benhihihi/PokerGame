...
public class PokerTest {
	...
	// Test case 9: n = 5, cards = {"CK", "DK", "HK", "SK", "DA"};
		@Test
		public void testKKKKA() {
			boolean result;
			String[] input = new String[] {"CK", "DK", "HK", "SK", "DA"};
			result = poker.isFourOfKind(input, 5);
			assertEquals(true, result);
		}
		
		// Test case 10: n = 5, cards = {"CK", "C1", "DK", "D1", "HK"};
				@Test
				public void testK1K1K() {
					boolean result;
					String[] input = new String[] {"CK", "C1", "DK", "D1", "HK"};
					result = poker.isFullHouse(input, 5);
					assertEquals(true, result);
				}
				
		// Test case 11: n = 5, cards =
}
